> **Language / Язык:** [English](08-server-api-package-upload.md) · **Русский**
...
Одна спека: **как** приложение отправляет пакет в **конкретный проект** на **конкретный сервер**, что видит пользователь (очередь, история), и **HTTP-контракт** (порядок шагов, коды, идемпотентность).

**Связанные документы:** [06-upload-lifecycle.ru.md](06-upload-lifecycle.ru.md) (жизненный цикл и ретраи на устройстве), [07-package-payload-structure.ru.md](07-package-payload-structure.ru.md) (`payload.json`, `blobs/`), [02-data-models-schema.ru.md](02-data-models-schema.ru.md) (идентификаторы).
...
Детали UI — в [03-user-journey-screens.ru.md](03-user-journey-screens.ru.md).
