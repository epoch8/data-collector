> **Language / Язык:** [English](json-driven-collection-ui.md) · **Русский**

# JSON → экран сбора (как в коде)

Статус: **актуально** (июнь 2026).

Пайплайн от JSON до Flutter-виджетов. **Как писать JSON** — [09-project-json-builder-guide.ru.md](09-project-json-builder-guide.ru.md). Модель данных — [../02-data-models-schema.ru.md](../02-data-models-schema.ru.md). Экраны — [../03-user-journey-screens.ru.md](../03-user-journey-screens.ru.md).
...
Меняете резолвер — обновите этот файл и [09-project-json-builder-guide.ru.md](09-project-json-builder-guide.ru.md).
