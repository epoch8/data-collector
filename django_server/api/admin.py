    ...
    fieldsets = (
        (
            None,
            {
                ...
                "description": (
                    "Назначьте «Доступные проекты» — без них каталог /v1/projects пустой и загрузка пакетов даст 403. "
                    "Список пользователей подтягивается из Firebase: нажмите «Синхронизировать с Firebase» "
                    "на предыдущей странице (или дождитесь первого входа в приложение). "
